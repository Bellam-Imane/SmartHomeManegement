...
const translations = {
  "Français": {
    ...
    notifData: {
      ...
      economie: { title: "Économie Hebdomadaire", desc: "Votre consommation a baissé de 10% par rapport à la semaine dernière." },
    ...
    profile: "Profile",
    profileDesc: "Gérez votre identité personnelle et vos identifiants d'accès.",
    nom: "Nom",
    prenom: "Prénom",
    email: "Email",
    phone: "Téléphone",
  ...
  "English": {
    ...
    notifData: {
      ...
      economie: { title: "Weekly Savings", desc: "Your power consumption dropped by 10% compared to last week." },
  ...
  "العربية": {
    ...
    notifData: {
      ...
      economie: { title: "توفير أسبوعي", desc: "انخفض استهلاكك للطاقة بنسبة 10% مقارنة بالأسبوع الماضي." },
